...
import {
    IconAlertCircle, IconApps, IconBorderAll, IconClipboard, IconFileDescription, IconHome,
    IconLogin, IconPoint, IconRotate, IconSettings, IconUserPlus, IconZoomCode
